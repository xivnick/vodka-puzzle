...
- 보름달 스도쿠: `/test/moon-sudoku/260925/`에서 6개 동심원 띠·6개 부채꼴·띠 2개 × 부채꼴 3개 영역에 1~6을 채우는 원형 스도쿠를 시연한다. `src/lib/moon-sudoku.js`가 단서와 입력 규칙을 관리하며 진행 저장·완료 기록·공개 목록 등록은 하지 않는다.
