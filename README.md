...
- `FormulaCompletion.astro`: 주어진 숫자를 정확히 한 번씩 사용한 사칙연산 수식을 유리수로 계산·검증하는 수식완성 화면. 260922 문제는 `/test/formula-completion/260922/`에서 기록·저장 없이 시연한다.
