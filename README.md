...
- `FormulaCompletion.astro`: 주어진 숫자를 정확히 한 번씩 사용한 사칙연산 수식을 유리수로 계산·검증하는 수식완성 화면. 정식 문제는 `/260922_01/`과 `/260922_02/`에서 서비스하며, `/test/formula-completion/260922/`와 `/test/formula-completion/260922-2/`는 기록·저장 없는 시연 경로로 유지한다.
