...
- `EqualSumSudoku.astro`: 일반 스도쿠 규칙과 회색 연결 영역의 동일 합을 검사하고 후보 숫자 메모를 지원하는 같은 합 스도쿠 화면. 사진 기반 문제는 `/test/equal-sum-sudoku/260921/`에서 기록·저장 없이 시연한다.
